Dynamo.SceneClear();
Dynamo.Console("test73_nodesPegasus");

//var peg = new NodesPegasus(@"C:\Andrei\Contracts\Toporkov\MONTAGE1000\MONTAGE.n.1000.0.dax");
var peg = new NodesPegasus(@"C:\Andrei\Contracts\Toporkov\MONTAGE1000\test.dax");
