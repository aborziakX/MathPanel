...
namespace MathPanelExt
{
	...
	{
		public delegate double PerformCalculation(object x, object y);

		int m_width, m_height;	//dimensions
		double[] m_weight;		//the weights or intermediate scores of cells
		int[] m_from;	//best parent
		...
		public PerformCalculation pc_hand = null;	//handler to compare objects
		public Similarica()
		{
			m_dMax = 0;
			m_iType = -1;
		...
		//compare objects
		public double Calc(object[] objWid, object[] objHei, PerformCalculation hand)
		{
		...
		double DoCalc()
		{
			...
			// find maximum weight in last row, column
