...
//TODO
/*
более точные координаты для дуба,
клена и березы
использовать typ для типа листа
size приводит к масштабированию
лист двухсторонний, создать грани в противоположном порядке
iter - сколько итераций фрактализации для увеличения точек на форме листа
divide - дополнительно разбить грани
color - применить разброс цвета
см. Trees.cs

в скрипте содать несколько листьев в в разных типах, позициях, ориентации, цветах
    */
